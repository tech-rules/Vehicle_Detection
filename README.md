...
Once I have  averaged and filtered the "heat blobs" with the above method, I use `scipy.ndimage.measurements.label()` function to obtain bounding boxes around car detections. (Lines 79-80 of [video.py](video.py))
